package mk.springframework.sfgrestdocsexample.web.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import mk.springframework.sfgrestdocsexample.domain.Beer;
import mk.springframework.sfgrestdocsexample.repositories.BeerRepository;
import mk.springframework.sfgrestdocsexample.web.model.BeerDto;
import mk.springframework.sfgrestdocsexample.web.model.BeerStyleEnum;
...
@AutoConfigureRestDocs(uriScheme = "https", uriHost = "dev.springframework.mk", uriPort = 80)
@WebMvcTest(BeerController.class)
@ComponentScan(basePackages = "mk.springframework.sfgrestdocsexample.web.mappers")
